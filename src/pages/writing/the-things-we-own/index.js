...
import ThingsOwnStyles from './the-things-we-own.module.css'
import Title from '../../../img/thingsOwnedTitle.svg'

export default class ThingsOwned extends React.Component {
  render() {
    return (
      <Layout>
        <div className={ThingsOwnStyles.white}>
        <section className={ThingsOwnStyles.intro}>
          ...
          <p>I’ve already written about that some. This story is less about that, and more about what was happening in parallel: my grandfather became depressed and then ill as this happened, and he ended up in a nursing home. This is a story about the aftermath. This is a story about <em>stuff</em>.</p>
        </section>

        <Title className={ThingsOwnStyles.title} />

        <p className={ThingsOwnStyles.basement}>When I was 19, I did something that made my father not speak to me for a year. I cleared out the basement and the attic.</p>

        <div className={ThingsOwnStyles.thePit}>
          <img src="/img/the-things-we-own/glorious-pit.jpg" alt="The Pit" />
        </div>

        <div className={ThingsOwnStyles.telescopeChillin}>
          <img src="/img/the-things-we-own/telescope-chillin.jpg" alt="Telescope chillin" />
        </div>

        <section className={ThingsOwnStyles.clarification}>
          <p>Of course that's not <em>quite</em> what I did. When I was 19, I threw away, donated, and sold an entire basement and attic’s worth of rocks, paperback books, receipts, trash I’d tried to throw away years ago, the inside pamphlets of video game boxes, and a million other equally random and inane things that one accumulates as one lives. My mother convinced my father to go away and spend time with family and while they were away my sister, husband and I threw away mountains of things.</p>
        ...
        <div className={ThingsOwnStyles.darkestHallway}>
          <img src="/img/the-things-we-own/darkest-hallway-ever.jpg" alt="The darkest hallway ever" />
        </div>

        <div className={ThingsOwnStyles.packingTape}>
          <img src="/img/the-things-we-own/packing-tape.jpg" alt="Packing tape" />
        </div>

        <section className={ThingsOwnStyles.mentalIllness}>
        ...
        <div className={ThingsOwnStyles.queensOfEngland}>
          <img src="/img/the-things-we-own/queens-of-england.jpg" alt="The Queens of England" />

          <em>Sampling: <br />
             —The Complete Works of Wiliam Shakespeare <br />
             —The History of Greece <br />
             —The Queens of England</em>
        </div>

        <span className={ThingsOwnStyles.parrot}>
          <img src="/img/the-things-we-own/parrot.jpg" alt="The parrot" />
        ...
        <ol className={ThingsOwnStyles.advice}>
          <li><strong className={ThingsOwnStyles.advicePoint}>Curate.</strong> You must maintain what you have, so only keep the things you truly wish to maintain.</li>

          <li><strong className={ThingsOwnStyles.advicePoint}>Save, but in new ways.</strong> I saved memories of my grandmother in an article that meant a lot to me. Sometimes all you want is to be able to see those things again, not actually hold them.</li>

          <li><strong className={ThingsOwnStyles.advicePoint}>Identify what ails you, and see how you feel a week later.</strong> If you are struggling to let go of something, ask yourself why. Because you think you might need it? Because you feel you are betraying someone by giving it away? Things can be repurchased in the future, and you betray no one by giving something away if it can bring someone else joy. Own things that bring you joy. It might hurt to give away something that once upon a time brought you joy, and it might hurt the next. But it probably won’t in a week.</li>
        </ol>

        <p className={ThingsOwnStyles.ending}>My father is very angry with me yet again, and I so desperately  wish I could not be the bad person. I wish there was a way to explain this to my father, that things are not the same as love. But instead, I am here, throwing and sorting and cleaning one thing at a time. Because I know I can take it, as does my mother, who knew of my cleaning expedition all those years ago. Because I know that with the things gone, we’ll be free to leave, and make new memories elsewhere. And because I know it’s gonna look good when I’m done.</p>
      </div>
      </Layout>
    )
  }
